...
<?php
$query_qViewTeamDetails = "SELECT * FROM team ORDER BY priority DESC";
...
<head>
    ...
    <title>Our Team :: International Social Health Organization</title>
    ...
    <section class="our-team sec-padd2">
        <div class="container">
            <div class="section-title">
                <h2 style="margin-top: 20px; margin-bottom: 20px;">Meet Our team</h2>
            </div>
            <div class="row">
                <?php do { ?>
                    <article class="col-md-3 col-sm-6 col-xs-12">
                        <div class="single-team-member">
                            <figure class="img-box">
                                <a><img src="admin/team/<?php echo $row_qViewTeamDetails['picture']; ?>" alt="<?php echo $row_qViewTeamDetails['name']; ?>" style="width: 100%; height: 200px;"></a>
                            </figure>
                            <div class="author-info">
                                <h4><?php echo $row_qViewTeamDetails['name']; ?></h4></a>
                                <p><?php echo $row_qViewTeamDetails['designation']; ?></p>
                            </div>
                    </article>
                <?php } while ($row_qViewTeamDetails = mysqli_fetch_assoc($qViewTeamDetails)); ?>
