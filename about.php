            ...
            <div class="row">
                ...
                <div class="col-md-5 col-sm-12">
                    ...
                    <figure class="img-box">
                        ...
                        <img src="images/about/3.png" alt="" style="height: 200px; width:100%; ">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="content">
                        ...
                        <h2>Every voice counts! Choose campaign, ISHO the world</h2>

                        <div class="text">

                            <p style="color: rgb(15, 15, 15); text-align:justify;">Every voice counts! Join the ISHO SOLUTIONS campaign, providing vital services like PS Fancy Light, health cards, and skilled manpower. Together, we can empower communities, enhance well-being, and create opportunities for a brighter, more inclusive future for everyone! </p>
                        ...
                        <div class="text">
                            ...
                            <p style="color: rgb(19, 20, 20); text-align:justify;">We offer innovative solutions like PS Fancy Light to enhance safety and visibility, health cards to improve access to medical care, and skilled manpower to meet diverse needs. By participating in this campaign, you’re not just raising your voice; you’re contributing to a movement that empowers individuals and fosters inclusivity. Together, we can create a brighter, healthier, and more equitable world. Let’s collaborate to ensure every voice is heard and every community thrives. Your involvement makes a real difference!</p>
