...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "newEmployee")) {
	
		$uploads_dir = "employee";
/*------------------------------------------------------------*/
  ...
  $insertSQL = "INSERT INTO employee (name, picture, mobile, city, state, address, emailID, empCode, creationDate) 
                VALUES ('$name', '$pname1', '$mobile', '$city', '$state', '$address', '$emailID', '$empCode', '$creationDate')";
    //echo $insertSQL;
  $Result1 = mysqli_query($conn, $insertSQL);

  $insertGoTo = "allEmployee.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-user" aria-hidden="true"></i> New Employee</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="fa fa-user" aria-hidden="true"></i> New Employee</li>						  	
					</ol>
				</div>
                <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="form">
                               <form action="<?php echo $editFormAction; ?>" method="POST" class="form-validate form-horizontal" role="form" name="newEmployee" enctype="multipart/form-data" >
                                  ...
                                  <div class="form-group">
                                      <label for="cname" class="control-label col-lg-2">Emp Name<span class="required">*</span></label>
                                      <div class="col-lg-10">
                                  ...
                                  <div class="form-group">
                                      <label for="cname" class="control-label col-lg-2">Emp Code<span class="required">*</span></label>
                                      <div class="col-lg-4">
                                          <input type="text" class="form-control" name="empCode" required>
                                      </div>
									  
									  <label for="cname" class="control-label col-lg-2">Emp Image<span class="required">*</span></label>
                                      <div class="col-lg-4">
                                  ...
                                  <input type="hidden" name="MM_insert" value="newEmployee">
                              </form>
